...
st.set_page_config(page_title='PreViz App',page_icon=':sunglasses:')
...
st.markdown("<h1 style='text-align: center; color:#0e178c;'>Data Visualiser</h1>", unsafe_allow_html=True)
...
#The user has options to do different things: either plot or predict.
    ...
    print(e)
    st.markdown("<h6 style='text-align: center; color:#0e178c;'>Welcome to the Project</h1>", unsafe_allow_html=True)
    st.image("https://media1.giphy.com/media/G4hjKwagsqgyk/giphy.gif",width =700)
